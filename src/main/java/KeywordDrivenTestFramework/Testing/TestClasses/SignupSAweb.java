...
public class SignupSAweb extends BaseClass {
    TestEntity testData;
    int counter = 1;

    public SignupSAweb(TestEntity testData) {
    ...
    public boolean SignupSAweb() {
        ...
        if (!SeleniumDriverInstance.enterTextByXpath(Main_Object.SignupEmail(), "marktheshark" + newDate +"@mailinator.com")) {
            return false;
        }
...
//        }
        ...
        if (!SeleniumDriverInstance.EnterTextByXpath(Main_Object.EducationInstitution(), "Winner no.1")) {
            return false;
        }
        if (!SeleniumDriverInstance.EnterTextByXpath(Main_Object.EducationName(), "The Institute")) {
            return false;
        }
        if (!SeleniumDriverInstance.clickElementbyXpath(Main_Object.EducationYearDrop())) {
            return false;
        }
        if (!SeleniumDriverInstance.clickElementbyXpath(Main_Object.EducationYearDrop1())) {
            return false;
        }
        if (!SeleniumDriverInstance.clickElementbyXpath(Main_Object.EducationNext())) {
            return false;
        }
