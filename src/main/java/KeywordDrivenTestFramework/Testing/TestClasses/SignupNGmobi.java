...
public class SignupNGmobi extends BaseClass {
    TestEntity testData;
    int counter = 1;

    public SignupNGmobi(TestEntity testData) {
    ...
    public boolean SignupNGmobi() {
        ...
        if (!SeleniumDriverInstance.navigateTo(Main_Object.CareersNGmobiUrl())) {
            return false;
        }
        ...
        if (!SeleniumDriverInstance.enterTextByXpath(Main_Object.CareersSAmobiLastName(), "SupermanNG")) {
            return false;
        }
